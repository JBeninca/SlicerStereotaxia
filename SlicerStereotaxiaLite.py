...
class SlicerStereotaxiaLiteWidget(ScriptedLoadableModuleWidget):
    ...
    def setup(self):
        ...
        self.Bton05 = qt.QPushButton("Abre DICOM")
        ...
        self.Bton7 = qt.QPushButton("NLocadores    U P W A R D")
        ...
        self.Grilla1.addWidget(self.Bton05, 2, 0, 1, 2)
        #self.Grilla1.addWidget(self.Bton1, 3, 0)
        #self.Grilla1.addWidget(self.Bton7, 2, 0)
        self.Grilla1.addWidget(self.Bton2, 3, 0, 1, 2)
        self.Grilla1.addWidget(self.Bton3, 5, 0)
        self.Grilla1.addWidget(self.Bton4, 5, 1)
        self.Grilla1.addWidget(self.Bton5, 7, 0, 1, 2)
        ...
        self.Bton05.clicked.connect(lambda: self.selectora_botones("DICOM"))
        ...
        #self.Bton7.clicked.connect(lambda: self.selectora_botones("NLocadores"))
    ...
    def selectora_botones(self, modo):
        ...
        if modo == "Inicializa":
            ...
            #if self.Bton7.text == "NLocadores   U P ward":
            #    self.Bton7.text = "NLocadores   D O W N ward"
            #else:
            #    self.Bton7.text = "NLocadores   U P ward"
    ...
    def actualiza_widget(self, param, event):
        ...
        if param.GetParameter("Registered_flag") != "True":
            return
        self.textEdit.append("NLocalizadores = " + param.GetParameter("UpOrDown_NLocadores"))    
...
class registracionLogic(ScriptedLoadableModuleLogic):
    ...
    def Inicializa_Escena(self):
        ...
        param = slicer.util.getNode("Param_data")
        param.SetParameter("UpOrDown_NLocadores", str("UP"))
    ...
    def main(self, obj, evento):  # funcion principal MAIN del procesamiento de fiduciarios
        ...
        if self.gest.nombre_Nodo == "f":
            ...
            transformada = self.maqui.Analisis_por_Landmarks(fiduciarios_TAC, fiduciarios_3D)
